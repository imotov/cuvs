...
public class CagraIndexImpl implements CagraIndex {
   ...
   * {@code mergedRowCount} rows, and
   * derives the row count of the merged index from the number of bits that are
   * set, so the words
   * have to cover every row rather than stop at the last one that survives.
   */
